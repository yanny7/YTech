...
public class YTechEntityTypes {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<DeerEntity>> DEER = ENTITIES.register("deer", () -> EntityType.Builder.of(DeerEntity::new, MobCategory.CREATURE).sized(0.9F, 1.6F).clientTrackingRange(10).build("deer"));
