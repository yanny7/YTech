...
public class YTechEntityTypes {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<TerrorBirdEntity>> TERROR_BIRD = ENTITIES.register("terror_bird", () -> EntityType.Builder.of(TerrorBirdEntity::new, MobCategory.CREATURE).sized(0.95F, 1.75F).clientTrackingRange(10).build("terror_bird"));
