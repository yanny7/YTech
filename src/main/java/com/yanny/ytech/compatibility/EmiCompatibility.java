...
public class EmiCompatibility implements EmiPlugin {
    ...
    private <I extends RecipeInput, T extends Recipe<I>> void registerRecipe(EmiRegistry registry, DeferredHolder<RecipeType<?>, RecipeType<T>> recipe, EmiRecipeCategory category, EmiIngredient icon, BiFunction<T, ResourceLocation, EmiRecipe> supplier) {
