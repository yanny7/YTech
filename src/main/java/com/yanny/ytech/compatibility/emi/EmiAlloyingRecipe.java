...
public class EmiAlloyingRecipe extends BasicEmiRecipe {
    ...
    public EmiAlloyingRecipe(AlloyingRecipe recipe, ResourceLocation id) {
        ...
        inputs = List.of(EmiIngredient.of(recipe.ingredient1().ingredient(), recipe.getInput1Count()), EmiIngredient.of(recipe.ingredient2().ingredient(), recipe.getInput2Count()));
