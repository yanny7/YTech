...
class YTechItemTags extends ItemTagsProvider {
    ...
    protected void addTags(@NotNull HolderLookup.Provider provider) {
        YTechConfigLoader.Material iron = YTechConfigLoader.getMaterial("iron");
        YTechConfigLoader.Material copper = YTechConfigLoader.getMaterial("copper");
        YTechConfigLoader.Material gold = YTechConfigLoader.getMaterial("gold");
