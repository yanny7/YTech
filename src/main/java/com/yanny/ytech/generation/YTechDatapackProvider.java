...
public class YTechDatapackProvider extends DatapackBuiltinEntriesProvider {
    ...
    private static RegistrySetBuilder getRegistrySet() {
        return new RegistrySetBuilder().add(ForgeRegistries.Keys.BIOME_MODIFIERS, bootstrap -> {
            ...
            bootstrap.register(ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, Utils.modLoc("overworld_terror_bird_spawn")),
                    new ForgeBiomeModifiers.AddSpawnsBiomeModifier(
