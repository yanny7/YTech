...
public class RemainingPartShapelessRecipe extends ShapelessRecipe {
    ...
    public static class Serializer implements RecipeSerializer<RemainingPartShapelessRecipe> {
        ...
        private static final Codec<RemainingPartShapelessRecipe> CODEC = RecordCodecBuilder.create(
        ...
        @NotNull
        @Override
        public Codec<RemainingPartShapelessRecipe> codec() {
            return CODEC;
        }

        @NotNull
        @Override
        public RemainingPartShapelessRecipe fromNetwork(@NotNull FriendlyByteBuf friendlyByteBuf) {
            return new RemainingPartShapelessRecipe(serializer.fromNetwork(friendlyByteBuf));
        }
