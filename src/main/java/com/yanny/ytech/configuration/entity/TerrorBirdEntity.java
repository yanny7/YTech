...
public class TerrorBirdEntity extends Animal {
    ...
    protected void registerGoals() {
        ...
        goalSelector.addGoal(1, new TemptGoal(this, 1.25D, Ingredient.of(BuiltInRegistries.ITEM.getOrThrow(YTechItemTags.TERROR_BIRD_TEMP_ITEMS)), false));
        ...
        targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, Animal.class, true, (entity, level) -> !(entity instanceof TerrorBirdEntity)));
    }
