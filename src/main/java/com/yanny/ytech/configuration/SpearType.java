...
public enum SpearType {
    ...
    public final RegistryObject<EntityType<SpearEntity>> entityType;
    ...
    SpearType(MaterialType materialType, RegistryObject<EntityType<SpearEntity>> entityType, int durability, float baseDamage, float attackSpeed, float shootPower, float accuracy, int throwThreshold) {
